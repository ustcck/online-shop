    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="onlineShopApp.wishList.home.createOrEditLabel" v-text="$t('onlineShopApp.wishList.home.createOrEditLabel')">Create or edit a WishList</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('onlineShopApp.wishList.title')" for="wish-list-title">Title</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('onlineShopApp.wishList.restricted')" for="wish-list-restricted">Restricted</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('onlineShopApp.wishList.customer')" for="wish-list-customer">Customer</label>
