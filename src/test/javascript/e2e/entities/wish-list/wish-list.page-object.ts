...
export default class WishListComponentsPage extends AlertPage {
...
export class WishListDeleteDialog {
  ...
  title: ElementFinder = element(by.id('onlineShopApp.wishList.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-wishList'));
}
