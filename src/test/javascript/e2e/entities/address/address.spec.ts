...
describe('Address e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Address page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/onlineShopApp.address.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/onlineShopApp.address.delete.question/);
